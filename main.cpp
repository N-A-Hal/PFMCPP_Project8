...
int main()
{
    ...
    cars.emplace_back("lada");
    cars.emplace_back("niva");
    /*
    ...
    motorcycles.emplace_back("honda");
    motorcycles.emplace_back("harley");

    trucks.reserve(3);
    
    trucks.emplace_back("kamaz");
    trucks.emplace_back("renault");
    trucks.emplace_back("ford");
